...
var goodone = (function () {
    function goodone(_RouteSegment) {
    ...
    goodone.prototype.addArticle = function (title, link, text) {
        this.articles.push(new Article(title.value, link.value, text.value));
        title.value = '';
        link.value = '';
        text.value = '';
    };
    goodone.prototype.clicked = function (button) {
        button.clicked = true;
    };
    goodone.prototype.reclicked = function (button) {
...
exports.goodone = goodone;
//# sourceMappingURL=goodone.js.map