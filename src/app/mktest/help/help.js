...
var help = (function () {
    ...
    help.prototype.addArticle = function (title, link, text) {
        this.articles.push(new Article(title.value, link.value, text.value));
        title.value = '';
        link.value = '';
        text.value = '';
    };
    help.prototype.clicked = function (button) {
        button.clicked = true;
    };
    help.prototype.reclicked = function (button) {
