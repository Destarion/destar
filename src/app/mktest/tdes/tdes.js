...
var tdes = (function () {
    ...
    tdes.prototype.addArticle = function (title, link, text) {
        this.articles.push(new Article(title.value, link.value, text.value));
        title.value = '';
        link.value = '';
        text.value = '';
    };
    tdes.prototype.clicked = function (button) {
        button.clicked = true;
    };
    tdes.prototype.reclicked = function (button) {
